#pragma once
/**
    @file IrisSDK_Tutorial_7.cpp
    @author Rebecca McWilliam <rmcwilliam@irisdynamics.com>
    @brief Entry point of the tutorial 7 application
    @version 1.1
...
int main() {
    ...
    while (1) {
        ...
        //call run_in, run_out and either set_force or set_position on the motor
