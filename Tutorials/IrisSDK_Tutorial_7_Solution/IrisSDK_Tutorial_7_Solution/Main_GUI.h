...
#include "Force_Control_Page.h"           // Force Control Page: an interface for updating an Orca motor's force using a generated signal and force effects
/**
    @file Main_GUI.h
    @class GUI
...
class GUI : public IC4_windows {
    ...
    FlexButton home_page_btn, pos_ctrl_page_btn, force_ctrl_page_btn;                          // Define FlexButton element for hiding/displaying the home page
